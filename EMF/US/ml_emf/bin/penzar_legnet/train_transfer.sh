...
#$ -l mem_free=60G     # job requires up to 1 GiB of RAM per slot
#$ -l scratch=60G      # job requires up to 2 GiB of local /scratch space
#$ -l h_rt=08:20:00   # job requires up to 24 hours of runtime
...
python3 /wynton/home/ahituv/fongsl/EMF/US/ml_emf/bin/train_transfer.py --train_valid_path "$1" --foldify --delimiter tab --seed 42 --train_batch_size 1024 --train_workers 8 --valid_batch_size 4098 --valid_workers 8 --epoch_num 10 --batch_per_epoch 500 --weights uniform --seqsize "$2" --temp .TEMPDIR --use_single_channel --singleton_definition integer --gpu 0 --model_dir "$3" --ks 7 --blocks 256 128 128 64 64 64 64 --resize_factor 4 --se_reduction 4 --shift 0.5 --scale 0.5 --loss kl --final_ch 18 --optimizer adamw --model /wynton/home/ahituv/fongsl/EMF/US/ml_emf/data/legnet/model_300.pth
