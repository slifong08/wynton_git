...
#$ -l h_rt=08:15:00   # job requires up to 24 hours of runtime
...
python3 /wynton/home/ahituv/fongsl/nullomers/bin-generate/kmers.py $SGE_TASK_ID "$1" 
# $SGE_TASK_ID = jobnumber
# $1 = Array
