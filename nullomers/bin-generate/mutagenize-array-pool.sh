...
#$ -l mem_free=500G     # job requires up to 1 GiB of RAM per slot
#$ -l scratch=500G      # job requires up to 2 GiB of local /scratch space
#$ -l h_rt=05:45:00   # job requires up to 24 hours of runtime
...
python3 /wynton/home/ahituv/fongsl/nullomers/bin-generate/mutagenize-array-pool.py $SGE_TASK_ID "$1" 
