...
#$ -l scratch=128G      # job requires up to 2 GiB of local /scratch space
#$ -l h_rt=01:30:00   # job requires up to 24 hours of runtime
...
python3 /wynton/home/ahituv/fongsl/nullomers/bin/gen/get_chr_kmers.py -c $SGE_TASK_ID -d "$1" -l "$2" 
