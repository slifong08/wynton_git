...
python3 /wynton/home/ahituv/fongsl/nullomers/bin-generate/get_kmer-keys-array.py $SGE_TASK_ID "$1" "$2" "$3" "$4" # ORDER OF ARGS MATTERS
# $SGE_TASK_ID = chrnum
# $1 = Array
# $2 = output directory
# $3 = kmer length
