...
#$ -l h_rt=01:40:00   # job requires up to 24 hours of runtime
...
python3 /wynton/home/ahituv/fongsl/nullomers/bin-generate/get_kmer-keys-array.py "$1" "$2" "$3" "$4" "$5" # ORDER OF ARGS MATTERS
# $1 = rerun job number
# $2 = Array
# $3 = output directory
# $4 = kmer length
