...
#$ -m a              # alerts to mail about
#$ -M sarah.fong@ucsf.edu # email to mail to
#$ -e /wynton/home/ahituv/fongsl/tools/qsub/log/"$JOB_ID".error.txt
#$ -o /wynton/home/ahituv/fongsl/tools/qsub/log/"$JOB_ID".output.txt
...
python3 /wynton/home/ahituv/fongsl/nullomers/bin/pipeline/8-LINSIGHT_expanded_array.py "$1" "$2" $SGE_TASK_ID
