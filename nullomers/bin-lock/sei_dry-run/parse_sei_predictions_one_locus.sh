...
#$ -l h_rt=01:15:00   # job requires up to 24 hours of runtime
...
echo python3 /wynton/home/ahituv/fongsl/nullomers/bin-lock/parse_sei_predictions_one_locus.py "$1" "$2" "$3" "$4"

python3 /wynton/home/ahituv/fongsl/nullomers/bin-lock/parse_sei_predictions_one_locus.py "$1" "$2" "$3" "$4"

# $1 = File 
# $2 = CL
# $3 = kmer length
# $4 = N mutations to make
#CL, MER, NMUTS, CONFIG
