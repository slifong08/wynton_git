...
#$ -l h_vmem=100G      # memory 
#$ -l mem_free=100G     # job requires up to 1 GiB of RAM per slot
#$ -l scratch=100G      # job requires up to 2 GiB of local /scratch space
#$ -l h_rt=20:15:00   # job requires up to 24 hours of runtime
...
python3 /wynton/home/ahituv/fongsl/nullomers/bin-lock/mutagenize_kmers.py "$1" "$2" "$3" "$4" "$5" "$6" # ORDER OF ARGS MATTERS
# $SGE_TASK_ID = chrnum
# $1 = CL
# $2 = kmer length
# $3 = N mutations to make
# $4 = genome build
# $5 = First order bool
# $6 = config (w full path)
#CL, MER, NMUTS, BUILD, FO_ONLY, CONFIG
